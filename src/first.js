...
function setup() {
  ...
  smoke.scale = 0.1;
  block[0].scale = 0.3;
  chicken[0].scale = 0.05;
  block[1].scale = 0.3;
  chicken[1].scale = 0.05;
  // block[1].addSpeed(1.5, 180);
  block[2].scale = 0.3;
  chicken[2].scale = 0.05;
  // block[2].addSpeed(1.5, 180);
  block[3].scale = 0.3;
  chicken[3].scale = 0.05;
...
function draw() {
  ...
  for (let i = 0; i < chicken.length; i++) {
    ...
    if (dogrun.overlap(chicken[i])) {
      ...
      let chickenY = chicken[i].position.y;
      let chickenVelX = chicken[i].velocity.x;
      //alert(i + 123);
      block[i].position.x = 1200;
      chicken[i].position.x = 1200;
